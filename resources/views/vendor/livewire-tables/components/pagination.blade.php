...
@elseif ($theme === 'bootstrap-5')
    <div class="d-lg-flex align-items-center mb-5 mt-3">
        @if ($component->paginationVisibilityIsEnabled())
            @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                <div class="mb-xxl-0 d-flex align-items-center justify-content-lg-start justify-content-center">
                    <span class="me-3 text-gray-600 fs-4 fs-xl-6">{{ __('messages.common.view') }}</span>
                    <select
                            wire:model="perPage"
                            id="perPage"
                ...
                @if ($component->paginationIsEnabled() && $rows->lastPage() > 1)
                    <div class="row flex-md-row-reverse flex-row flex-column-reverse mx-0 w-100">
                        <div class="col-12 col-xxl-9 col-md-8 overflow-auto pagination-center ms-auto">
                            {{ $rows->links('livewire-tables::specific.bootstrap-4.pagination') }}
                        </div>
                        <div class="col-12 col-xxl-3 col-md-4 text-center text-lg-end text-gray-600 d-flex align-items-center justify-content-md-start justify-content-center mb-md-0 mb-3 flex-wrap ps-0 mt-3 mt-lg-0">
