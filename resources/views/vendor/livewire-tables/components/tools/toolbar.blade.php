...
<div class="d-md-flex justify-content-between mb-3 livewire-search-box align-items-center">
    <div class="d-md-flex">
        ...
        @if ($component->searchIsEnabled() && $component->searchVisibilityIsEnabled())
                ...
                <div class="mb-3 mb-sm-0">
                    <div class="position-relative d-flex width-320  width-sm-280">
                        <span class="position-absolute d-flex align-items-center top-0 bottom-0 left-0 text-gray-600 ms-3"> <i
                                    class="fa-solid fa-magnifying-glass"></i> </span> {{-- <input class="form-control ps-8" type="search" placeholder="Search" aria-label="Search">--}}
                        <input type="search"
                               wire:model{{ $component->getSearchOptions() }}="{{ $component->getTableName() }}.search"
                               data-datatable-filter="search" name="search"
                               class="form-control w-250px ps-10" placeholder="{{__('messages.common.search')}}"/>
                    </div>
                </div>
            @endif
    ...
    <div class="d-flex justify-content-end {{ Request::is('appointments') ? 'custom-d-block' : '' }}">
