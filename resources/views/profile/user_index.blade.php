...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form id="profileForm" method="POST" action="{{ route('user.update.profile.setting') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row mb-5">
                        <div class="col-lg-4">
                            ...
                            <div class="mb-3" io-image-input="true">
                                <div class="d-block">
                                    <div class="image-picker">
                                        <div class="image previewImage" id="exampleInputImage" {{ $imageCss }}="background-image: url('{{ $user->profile_image }}')
                                        ">
                                    </div>
            ...
            <div class="row mb-5">
                ...
                <label class="col-lg-4 form-label required">{{ __('messages.user.contact_no').':' }}</label>

                <div class="col-lg-8">
                    {{ Form::tel('contact', $user->contact ? '+'.$user->region_code.$user->contact : null, ['id'=>'phoneNumber','class' => 'form-control', 'placeholder' =>  __('messages.user.contact_no'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
