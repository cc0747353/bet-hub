...
@section('content')
    <div class="d-flex flex-column flex-column-fluid align-items-center justify-content-center p-4">
        ...
        <div class="bg-white rounded-15 shadow-md width-540 px-5 px-sm-7 py-10 mx-auto">
            <h1 class="text-center mb-7">{{__('Reset Password')}}</h1>
            <form method="POST" action="{{ route('password.update') }}" id="">
                ...
                {{--Password--}}
                <div class="mb-sm-7 mb-4">
                    <label class="form-label" for="password">{{__('messages.user.new_password').':' }}
                ...
                <div class="fv-row mb-5">
                    <label class="form-label" for="password_confirmation">{{ __('messages.user.password_confirmation').':' }}
                        <span class="required"></span>
                    </label>
