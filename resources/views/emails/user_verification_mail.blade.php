@component('mail::layout')
    ...
    @php
        $color = 'primary';
                $googel_map  = '<div style="display: flex; justify-content: center;"><a target="_blank" class="button button-primary" style="margin-bottom: 15px"  href="'.$url.'">Verify Email Address</a></div>';
                    $search = array('#link#');
