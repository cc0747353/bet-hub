    ...
    @php
        $color = 'primary';
                $google_map  = '<a target="_blank" class="button button-primary" style="margin-bottom: 15px"  href="'.route('user.bets-details').'">View</a>';
                    $search = array('#currency#','#winner_amount#','#match#','#question#','#option#','#invest_amount#','#link#');
                    $replace = array($currency,$winner_amount,$match,$question,$option,$invest_amount,$google_map);
